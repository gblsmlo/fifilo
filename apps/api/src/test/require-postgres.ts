...
/**
 * Every integration test in this app that needs real PostgreSQL calls this
 * first, so a missing service fails naming the prerequisite instead of
 * surfacing as a connection error indistinguishable from a regression
 * (test-plan.md § 3).
 */
